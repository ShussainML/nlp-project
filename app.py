...
def predict_author_name(model, tokenizer, text):
    ...
    inputs = tokenizer(preprocessed_text, return_tensors="pt", max_length=128, padding=True, truncation=True)
    with torch.no_grad():
